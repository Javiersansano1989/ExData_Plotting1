...
plot(relevant_timeframe$Time, relevant_timeframe$Global_active_power, type = "l", main = "Global Active Power Over Time", ylab = "GAP [kW]", xlab = "Date & Time", cex = 0.8)
  mtext("* Chronological Variation of Global Active Power *", side = 3, line = 0.5, cex = 0.7)

plot(relevant_timeframe$Time, relevant_timeframe$Voltage, type = "l", main = "Voltage Over Time", ylab = "Voltage [V]", xlab = "Date & Time", cex = 0.8)
  mtext("* Chronological Variation of Voltage *", side = 3, line = 0.5, cex = 0.7)

plot(relevant_timeframe$Time, relevant_timeframe$Sub_metering_1, type = "l", main = "Energy Sub-metering Over Time", ylab = "Energy sub-metering [Wh]", xlab = "Date & Time", cex = 0.8)
  ...
  mtext("* Energy consumption over time *", side = 3, line = 0.5, cex = 0.7)

plot(relevant_timeframe$Time, relevant_timeframe$Global_reactive_power, type = "l", main = "Global Reactive Power Over Time", ylab = "GRP [kW]", xlab = "Date & Time", cex = 0.8)
  mtext("* Chronological Variation of Global Reactive Power *", side = 3, line = 0.5, cex = 0.7)
